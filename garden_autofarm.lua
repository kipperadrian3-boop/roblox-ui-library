--[[
    1:1 Deobfuscated MoonSec V3 Script Suite (Keyless)
    Official Un-Obfuscated Lua Source Code
]]
...
-- --------------------------------------------------------------------
function ScriptSuite.BoostPetFPS()
...
-- --------------------------------------------------------------------
function ScriptSuite.CleanPetAnimations()
    local petsPhysical = Workspace:FindFirstChild("PetsPhysical")
    if not petsPhysical then return end
...
-- --------------------------------------------------------------------
function ScriptSuite.AutoGiveFruits(config, timer, targetFolder, helper)
    return function()
...
-- --------------------------------------------------------------------
function ScriptSuite.AutoWaterFruits(config, helper, player, remotes)
    return function()
...
-- --------------------------------------------------------------------
function ScriptSuite.AutoPetMutationMachine(config, helper, remotes, state, player)
    return function()
...
-- --------------------------------------------------------------------
function ScriptSuite.CheckEggFilter(config, utils, helper, player)
    return function()
...
-- --------------------------------------------------------------------
function ScriptSuite.UpdateEggVisuals(config, utils, helper, espManager, formatHelper, player)
    return function()
...
-- --------------------------------------------------------------------
function ScriptSuite.AutoCollectCrops(config, inventory, options, helper, remotes)
    return function()
